pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/lewisjp3/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('lewisjp3-225-2')   // <---- Change this to match your kubernetes cluster credentials
    }
